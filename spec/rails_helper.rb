...
RSpec.configure do |config|
  ...
  config.before(:suite) do
    ...
    # Coporate.__elasticsearch__.create_index!(force: true)
    # Event.__elasticsearch__.create_index!(force: true)
    # Letter.__elasticsearch__.create_index!(force: true)
    # Location.__elasticsearch__.create_index!(force: true)
    # Personal.__elasticsearch__.create_index!(force: true)
